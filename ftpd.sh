...
#FTPD_HOME=/opt/apache-ftpserver-1.1.1/bin/./..
...
CURR_DIR=`pwd`
cd $FTPD_HOME
MAIN_CLASS=org.apache.ftpserver.main.Daemon
"$JAVACMD" -classpath "$FTPD_CLASSPATH" $MAIN_CLASS start res/conf/ftpd-conf.xml 
RESULT=$?
cd $CURR_DIR
exit $RESULT
